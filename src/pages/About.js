    ...
    <div className="container py-5">
      <div className="row align-items-center">
        <div className="col-md-12">
          ...
          <p className="text-light">
            ...
            <ul>
              <li>Civilian and utility vehicles </li>
              <li>Emergency response vehicles </li>
              <li>Military vehicles and equipment </li>
              <li>Motorbikes and aircraft </li>
              <li>Unique concepts like flying cars </li>
              <li>And much more…</li>
            </ul>
          </p>
          <p className="text-light">
      ...
      <section className="py-5" style={{ backgroundColor: '#0B0909', color: '#fff' }}>
        <div className="container">
          ...
          <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-md-4 g-4" style={{gap: '0'}}>
